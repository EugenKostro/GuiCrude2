...
updateBtn=Button(root, text="Ažuriraj",padx=65,pady=25,width=10,bd=5,font=('Arial',15),bg="white",fg="red", command=update)
deleteBtn=Button(root, text="Izbriši",padx=65,pady=25,width=10,bd=5,font=('Arial',15),bg="white",fg="red", command=delete)
searchBtn=Button(root, text="Pretraži",padx=65,pady=25,width=10,bd=5,font=('Arial',15),bg="white",fg="red", command=search)
resetBtn=Button(root, text="Resetiraj",padx=65,pady=25,width=10,bd=5,font=('Arial',15),bg="white",fg="red", command=reset)
